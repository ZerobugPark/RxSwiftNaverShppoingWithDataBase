...
enum NaverRequestRxSwift {
    ...
    case getInfo(query: String, display: Int, sort: String = "sim", startIndex: Int)
    ...
    var parameters: [String: String] {
        switch self {
        case let .getInfo(query, display, sort, startIndex):
            return ["query": query, "display": "\(display)", "sort": sort, "start": "\(startIndex)"]
        }
    }
...
class NetworkManagerRxSwift {
    ...
    func callRequest(api: NaverRequestRxSwift) -> Single<Result<NaverShoppingInfo, APIError>> {
